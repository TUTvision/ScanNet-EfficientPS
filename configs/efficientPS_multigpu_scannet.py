...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(1280, 960), ratio_range=(0.5, 2.0), keep_ratio=True),
    dict(type='RandomCrop', crop_size=(960, 1280)),
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'scannet_detection_continuous_ids_train.json',
        img_prefix=data_root + 'images/',
        seg_prefix=data_root + 'scannet_semantic_continuous/',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'scannet_detection_continuous_ids_val.json',
        img_prefix=data_root + 'images/',
        seg_prefix=data_root + 'scannet_semantic_continuous/',
        panoptic_gt=data_root + 'scannet_panoptic_val',
